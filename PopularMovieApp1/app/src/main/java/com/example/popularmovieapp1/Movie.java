...
//Implementing comparable for sorting
public class Movie implements Comparable<Movie> {
    ...
    //Constructor with selected inputs going into the mainActivity
    public Movie(Double popularity, String posterPath, String title, String overview, String releaseDate) {
        this.popularity = popularity;
        this.posterPath = posterPath;
        this.title = title;
        this.overview = overview;
    ...
    public int compareTo(Movie otherMovie) {
        return this.popularity.compareTo(otherMovie.popularity);
